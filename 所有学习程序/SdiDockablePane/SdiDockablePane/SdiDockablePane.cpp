...
// SdiDockablePane.cpp : 定义应用程序的类行为。
//
...
// 唯一的一个 CSdiDockablePaneApp 对象

CSdiDockablePaneApp theApp;


// CSdiDockablePaneApp 初始化
...
// CSdiDockablePaneApp 自定义加载/保存方法
