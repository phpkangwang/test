...
// SdiDockablePaneView.cpp : CSdiDockablePaneView 类的实现
//
...
CSdiDockablePaneDoc* CSdiDockablePaneView::GetDocument() const // 非调试版本是内联的
{
